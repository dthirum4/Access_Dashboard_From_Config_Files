	...
	public static int get_dashboard_list() throws Exception {
		...
		try {
			...
			for (dashboard_list_row_value = 1; dashboard_list_row_value < total_rows; dashboard_list_row_value++) {
				...
				String dashboard_name = Select_credentials.get_dashboard_list(dashboard_list_row_value, 0);
				String dashboard_link = Select_credentials.get_dashboard_list(dashboard_list_row_value, 1);
				String dashboard_target_value = Select_credentials.get_dashboard_list(dashboard_list_row_value, 2);
				...
				WebElement Dest_Element = driver
						.findElement(By.xpath("//*[contains(./text(),'" + dashboard_target_value + "')]"));
